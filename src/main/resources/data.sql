...
insert into tu_team values ('e38b9008-3168-4ef7-b511-a6d30dbf2869', 'Volleyball', '95b45ea8-8dd9-49c0-91f3-ccb0b912d12a', '03/04/2024 17:00', 'Stockholm Sport Center', 12) ON CONFLICT (id) do nothing;
insert into tu_team values ('1ba0d20c-5e69-4ba3-866a-50cf5a4d434c', 'Volleyball', '95b45ea8-8dd9-49c0-91f3-ccb0b912d12a', '03/04/2024 17:00', 'Stockholm Sport Center', 12) ON CONFLICT (id) do nothing;
...
insert into tu_team_user_list values ('e38b9008-3168-4ef7-b511-a6d30dbf2869', 'f5525b2c-bcf3-44f6-86e6-4991459fed19');
